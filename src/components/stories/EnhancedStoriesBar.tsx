            ...
            return (
              ...
              >
                <div className="relative">
                  {/* Story ring - different colors for read/unread */}
                  <div
                    className={`w-16 h-16 rounded-full overflow-hidden border-3 p-0.5 group-hover:scale-105 transition-transform ${
                      hasUnread
                        ? "bg-gradient-to-r from-purple-500 to-pink-500" // Unread - colorful gradient
                        : "bg-gray-300" // Read - gray
                    }`}
                  >
